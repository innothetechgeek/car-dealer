...
@section('jumbotron')
    <section class="jumbotron">
            ...
            <p>
                <a href="{{ route('addcar') }}" class="btn  my-2 bcg-dark">Add New Listing</a>
            </p>
            </div>
    </section>
@endsection
@section('body')      
    ...
    <!-- show toast at the bottom of the page 
        displays car name deleted / updated successfully at the bottom of the page -->
    <?php if(Session::has('status')){ ?>
                <script>
                    ...
                    showToast(message); //displays car deleted / updated successfully !

                    if(item_id != '') applyAmimationAfterAddOrEdit(item_id); //scroll to car after editing or deleting      
